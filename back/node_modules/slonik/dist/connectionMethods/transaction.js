...
const execTransaction = async (parentLog, connection, clientConfiguration, handler) => {
    ...
    try {
        const result = await handler((0, bindTransactionConnection_1.bindTransactionConnection)(parentLog, connection, clientConfiguration, poolClientState.transactionDepth));
